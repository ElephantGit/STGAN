...
att_default = ['Bags_Under_Eyes', 'Big_Lips', 'Big_Nose', 'Double_Chin', 'Goatee', 'Gray_Hair', 'High_Cheekbones', 
               'Narrow_Eyes', 'Pointy_Nose', 'Sideburns', 'Wearing_Necklace', 'Wearing_Necktie']
...
# initialization
ckpt_dir = './output_train_3rd_att/%s/checkpoints' % experiment_name
