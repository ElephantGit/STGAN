...
parser.add_argument('--dataroot', type=str, default='./data/red/')
...
# data
sess = tl.session()
te_data = data_red.Red(dataroot, atts, img_size, 1, part='test', sess=sess, crop=not use_cropped_img, im_no=img)
# models
...
# --experiment_name 128 --test_int 1.0 --img 0

# testing multiple attributes
# --experiment_name 128 --test_atts Pale_Skin Male --test_ints 1.0 1.0 --img 0

# attribute intensity control
# --experiment_name 128 --test_slide --test_att Bald --test_int_min 0.6 --test_int_max 1.0 --n_slide 10 --img 0
    ...
    for idx, batch in enumerate(te_data):
        ...
        if test_slide: # test_slide
            ...
            for a in test_atts:
                ...
                b_sample_ipt_list[-1] = data_red.Red.check_attribute_conflict(b_sample_ipt_list[-1], atts[i], atts)
            ...
            for i in range(len(atts)):
                ...
                # print('2:', tmp)
                tmp = data_red.Red.check_attribute_conflict(tmp, atts[i], atts)
                # print('3:', tmp)
