...
# att_default = ['Arched_Eyebrows', 'Attractive', 'Chubby', 'Heavy_Makeup', 'Oval_Face', 'Receding_Hairline', 
#                'Rosy_Cheeks', 'Smiling', 'Straight_Hair', 'Wavy_Hair', 'Wearing_Earrings', 'Wearing_Hat', 'Wearing_Lipstick']
att_default = ['Arched_Eyebrows', 'Black_Hair', 'Blond_Hair', 'Brown_Hair', 'Bushy_Eyebrows', 'Male', 'Mustache',
               'No_Beard', 'Pale_Skin', 'Receding_Hairline', 'Smiling', 'Wearing_Lipstick', 'Young']
...
# initialization
ckpt_dir = './output_train_selected_att/%s/checkpoints' % experiment_name
